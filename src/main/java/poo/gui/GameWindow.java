...
public class GameWindow extends Application implements GameListener {
	...
	public void start(Stage primaryStage) {
		...
		passaJ2.setOnAction(e -> Game.getInstance().nextPlayer());

		Button UsarTreinadorJ1 = new Button("Usar treinador");
		...
		grid3.add(colocaZonaPrincipalReservaJ2, 2, 4);
		...
		Button recuoj1 = new Button("Recuo");
		grid3.add(recuoj1, 3, 1);
		recuoj1.setOnAction(e -> Game.getInstance().recuo(1));

		Button recuoj2 = new Button("Recuo");
		grid3.add(recuoj2, 3, 3);
		recuoj2.setOnAction(e -> Game.getInstance().recuo(2));
		...
		// Button VidaPokemon1 = new Button
		// (String.valueOf(Game.getInstance().getVidaZ1()));
